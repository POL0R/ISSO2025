...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg,#60496e8c 1000%,#71C4FF44 1000%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const animationHandlers = useMemo(() => {
    ...
    const createSmoothAnimation = (
      ...
      const targetY = wrap.clientHeight / 1;
  ...
  useEffect(() => {
    ...
    const handleClick = () => {
      // Always trigger navigation if provided
      onCardClick?.();

      // Separately handle mobile tilt permission without blocking navigation
